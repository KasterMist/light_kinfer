...
# 检测设备类型（NVIDIA GPU、AMD GPU 或 CPU）
def detect_device():
    try:
        ...
        if gpu_type == "amd":
            ...
            for line in result.stdout.splitlines():
                if "VRAM Total Used Memory" in line:
                    ...
                    return float(used) / (10**9)  # 将 MiB 转换为 GiB
            ...
            return float(result.stdout.strip()) / 1024  # 将 MiB 转换为 GiB
        elif gpu_type == "cpu":
            return None
